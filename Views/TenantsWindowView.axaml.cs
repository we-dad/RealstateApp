...
public partial class TenantsWindowView : Window
{
    private readonly Tenant _tenant;
    private readonly DbService _db = new DbService();
    private readonly TenantService _tenantDB;


    public TenantsWindowView(Tenant tenant)
    {
        InitializeComponent();

        _db.Initialize();
        _tenantDB = new TenantService(_db);
    ...
    private void Update_Click(object? sender, RoutedEventArgs e)
    {
        try
        {
            ...
            _tenantDB.Update(_tenant.Id, name, identityNumber, phone, address);
    ...
    {
        var Refresh_tenant = _tenantDB.GetById(_tenant.Id);
